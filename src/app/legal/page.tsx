...
export const metadata: Metadata = {
  ...
  description:
    "Terms and policies for the Cole Goodwin official website, operated by Borchetta Entertainment Group, LLC and its affiliates.",
  alternates: { canonical: "https://colegoodwinmusic.com/legal" },
...
export default function LegalHubPage() {
  return (
    <section data-bg="primary" className="cg-legal bg-background-primary px-5 pt-28 pb-20 md:pb-28 lg:px-12">
