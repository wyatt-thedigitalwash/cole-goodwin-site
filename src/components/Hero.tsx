...
export default function Hero() {
  return (
    <section
      className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-brown px-5 pb-16 pt-28 md:px-8 md:pt-32"
      data-bg="brown"
    >
      ...
      <div className="relative mx-auto w-[90%] max-w-[calc(32rem*0.9)] md:max-w-[calc(36rem*0.9)] lg:max-w-[calc(42rem*0.9)]">
        ...
        <div className="hero-reveal-frame relative z-10">
          <div className="overflow-hidden rounded-2xl border-[5px] border-black md:rounded-3xl md:border-[6px]">
            <div className="relative aspect-square w-full">
              <Image
                ...
                className="hero-photo-breathe object-cover object-top"
                priority
              />
            </div>
          </div>
        ...
        <div className="hero-reveal-cta mt-8 flex justify-center md:mt-10">
          <a
        ...
        <div className="hero-reveal-title absolute -top-[10%] left-0 z-30 w-[74%] md:-top-[11%] md:w-[67.5%]">
          <Image
        ...
        <div className="hero-reveal-name absolute -top-[10%] right-[-7%] z-20 w-[34%] md:-top-[12%] md:right-[-1%] md:w-[31.5%]">
          <Image
