...
export default function LegalArticle({
  ...
  return (
    <>
      <section data-bg="primary" className="cg-legal bg-background-primary px-5 pt-28 pb-4 lg:px-12">
      ...
      <section data-bg="primary" className="cg-legal bg-background-primary px-5 pb-20 md:pb-28 lg:px-12">
